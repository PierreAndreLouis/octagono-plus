...
function Login2() {
  ...
  const [showLangueAndCountryOption, setShowLangueAndCountryOption] =
    useState(false);
  return (
    <div className="grid md:pb-20  relative md:grid-cols-2 items-center min-h-[100vh] bg-sky-900  md:mx-auto md:px-[5vw]  lg:gap-20 m-0  text-white">
      <img
      ...
      />
      <div></div>
      <div className="flex md:scale-90 hover:scale-100 transition-all bg-white/70 relative  z-10 flex-1 flex-col justify-center pt-4 py-10  border-2--- border-blue-900 px-4 pb-20 md:pb-8 rounded-lg backdrop-blur-lg  bg-blue-800/30--">
