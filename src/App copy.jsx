            ...
            <div className="flex gap-5">
              ...
              >
                ...
                >
                  ...
                  >
                    <MdInstallDesktop className="text-2xl text-orange-600" />
                  ...
                  <div className="ajouter-appareil-container transition-all hover:border  hover:rounded-lg">
                    ...
                    <div className="ajouter-appareil-other overflow-hidden">
                      <div className="flex hover:text-orange-700 cursor-pointer gap-5 pr-2 items-center--">
                        <TbPointFilled className="mt-1" />
                        <p>Choisir un autre appareil a modifier</p>
                      </div>
                    </div>
                  </div>
                  {/* Fin */}
                  ...
                  >
                    <GoTrash className="text-xl text-orange-600" />
